...
import kotlinx.android.synthetic.main.list_item_store_main_image.view.*


class StoreMainImageAdapter(context: Context): RecyclerView.Adapter<StoreMainImageAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val inflatedView = LayoutInflater.from(parent.context).inflate(
            R.layout.list_item_store_main_image,
            parent,
            false
        )
    ...
    class ViewHolder(convertView: View) : RecyclerView.ViewHolder(convertView) {
        ...
        init {
            ...
            mMarjinView = convertView.list_item_store_main_image_margin_view
            mImageView = convertView.list_item_store_main_image_view
        }
    }
}