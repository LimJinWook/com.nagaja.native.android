...
class LocationAreaMainData : Serializable {
    ...
    private var mLocationAreaSubListData = ArrayList<LocationAreaSubData>()
    ...
    fun setLocationAreaSubListData(locationAreaSubListData: ArrayList<LocationAreaSubData>) {
        mLocationAreaSubListData = locationAreaSubListData
    }

    fun getLocationAreaSubListData(): ArrayList<LocationAreaSubData> {
        return mLocationAreaSubListData
    }
