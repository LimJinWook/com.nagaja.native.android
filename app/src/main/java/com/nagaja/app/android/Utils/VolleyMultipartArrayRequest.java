...
public class VolleyMultipartArrayRequest extends Request<JSONObject> {
    ...
    public VolleyMultipartArrayRequest(String url, Map<String, String> headers,
    ...
    public VolleyMultipartArrayRequest(int method, String url,
                                       Response.Listener<JSONObject> listener,
                                       Response.ErrorListener errorListener) {
